...
public class PagerTabStripActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_pager_tab_strip, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_pager_tab_strip, container, false);

            TextView txt = (TextView) rootView.findViewById(R.id.section_label);
            int position = getArguments().getInt(ARG_SECTION_NUMBER, -1);
            txt.setText(String.format("Fragment %d", position));
